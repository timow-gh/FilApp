...
filament::Camera::Projection toFilamentProjection(ViewConfig::CameraProjection cameraProjection)
{
  ...
  case ViewConfig::CameraProjection::PERSPECTIVE: return filament::Camera::Projection::PERSPECTIVE;
  }
  return filament::Camera::Projection::ORTHO;
}

filament::camutils::Fov toFilamentFovDirection(ViewConfig::FieldOfViewDirection fieldOfViewDirection, FilamentCamUtilsTag)
{
...
filament::Camera::Fov toFilamentFovDirection(ViewConfig::FieldOfViewDirection fieldOfViewDirection, FilamentCameraTag)
{
  switch (fieldOfViewDirection)
  {
...
{
  return {static_cast<int32_t>(viewport.left), static_cast<int32_t>(viewport.bottom), viewport.width, viewport.height};
}
...
SDL_Scancode toSDLScancode(KeyScancode scancode)
{
  ...
  default: CORE_POSTCONDITION_DEBUG_ASSERT(false, "KeyScancode not known."); return SDL_SCANCODE_UNKNOWN;
  }
}
KeyScancode toKeyScancode(SDL_Scancode sdlScancode)
{
  ...
  default: CORE_POSTCONDITION_DEBUG_ASSERT(false, "SDL_Scancode not known."); return KeyScancode::SCANCODE_UNKNOWN;
  }
}
