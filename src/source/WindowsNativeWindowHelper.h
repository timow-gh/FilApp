...
#ifndef FILAPP_WINDOWSNATIVEWINDOWHELPER_H
#define FILAPP_WINDOWSNATIVEWINDOWHELPER_H
...
// Resize the backing CAMetalLayer's drawable to match the new view's size.
// Returns the layer.
extern "C" void* resizeMetalLayer(void* nativeView);
#endif

#endif // FILAPP_WINDOWSNATIVEWINDOWHELPER_H
