...
public:
  ...
  CORE_NODISCARD std::optional<LinAl::Vec3d> calcSnapPoint(const Geometry::Ray3d& placementRay) const;
...
private:
  ...
  CORE_NODISCARD static std::optional<LinAl::Vec3d> findClosestSnapPoint(const LinAl::Vec3dVector& snapPoints,
                                                                         const Geometry::Ray3d& placementRay);

  void addSphereSurfaceSnapPoint(LinAl::Vec3dVector& m_snapPoints, const Geometry::Ray3d& placementRay) const;
};
