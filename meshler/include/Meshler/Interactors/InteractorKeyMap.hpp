...
private:
  void initMap()
  {
    m_keyMap = {{Graphics::KeyScancode::SCANCODE_1, InteractorCommand(Command::PLACING_INTERACTOR_SPHERE)},
                {Graphics::KeyScancode::SCANCODE_2, InteractorCommand(Command::PLACING_INTERACTOR_CONE)},
                {Graphics::KeyScancode::SCANCODE_3, InteractorCommand(Command::PLACING_INTERACTOR_CYLINDER)},
                {Graphics::KeyScancode::SCANCODE_4, InteractorCommand(Command::PLACING_INTERACTOR_CUBOID)}};
  }
};
